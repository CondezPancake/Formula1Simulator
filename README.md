...
<p align="center">
  ...
  <img alt="Tests" src="https://img.shields.io/badge/tests-43%20passing-2ea043?style=flat-square">
</p>
...
**Simulación** — Clima aleatorio según la distribución del circuito, cálculo del tiempo de los 20 pilotos, parrilla ordenada con la pole destacada y diferencias respecto a ella. La vuelta del piloto seleccionado muestra en vivo velocidad, consumo acumulado y desgaste. La sesión incluye un resumen y gráficos comparativos de tiempo, diferencia, consumo y desgaste. Todo corre en segundo plano sin congelar la ventana.
