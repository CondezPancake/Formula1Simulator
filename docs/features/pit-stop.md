...
La pérdida se incorpora progresivamente al tiempo acumulado. Por tanto, la
...
HU-51 podrá asociar el trabajo sobre neumáticos a la fase `STOPPED` sin cambiar
la decisión ni el ciclo de la parada. HU-49 podrá consumir los snapshots desde
